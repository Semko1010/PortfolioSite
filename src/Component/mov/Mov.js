...
class Mov extends Component {
	...
	handleScroll1 = () => {
		...
		if (elPosition.top + 100 < screenPosition) {
			...
			document.querySelector(".movText").style =
		...
		return (
			<div className='mov'>
				<div className='movText'>
					...
					<a
						href='https://the-movie-app-2021.netlify.app/'
						target='_blank'
						rel='noreferrer'
						class='movie-flip'
						data-back='Movie App'
				...
				<img
					...
					id='img1'
					src='./img/mov/Bildschirmfoto 2021-12-29 um 09.59.27.png'
					alt=''
				/>
				<img
					style={{ transform: `translateY(${-this.state.scroll * 0.6}px)` }}
					id='img2'
					src='./img/mov/Bildschirmfoto 2021-12-29 um 09.58.07.png'
					alt=''
				/>
				<img
					style={{ transform: `translateY(${-this.state.scroll * 0.9}px)` }}
					id='img3'
					src='./img/mov/Bildschirmfoto 2021-12-29 um 09.56.23.png'
					alt=''
				/>
			</div>
		);
